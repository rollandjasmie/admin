        ...
        return (
            <>
                ...
                <div className=" mx-auto flex flex-wrap p-1  md:flex-row items-center">
                    <NavLink to="/" className="homelog1 sm:w-8/12 flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                   ...
                   <button className=" hover:font-bold text-white
                      rounded hover:bg-orange-500 shadow-lg px-4 py-2 lg:mr-4 md:mr-4 sm:ml-2">S'inscrire</button>
                    </NavLink>   
                    </div>
